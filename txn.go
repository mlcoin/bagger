...
//
// 5. If callback is provided, Bagger will return immediately after checking
...
// providing serializable snapshot isolation, avoiding write skews. Bagger achieves this by tracking
