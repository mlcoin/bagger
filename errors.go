...
var (
	...
	// ErrInvalidKey is returned if the key has a special !bagger! prefix,
	// reserved for internal usage.
	ErrInvalidKey = errors.New("Key is using a reserved !bagger! prefix")
