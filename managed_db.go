...
//
// This is only useful for databases built on top of Bagger (like Dgraph), and
...
// DropAll would drop all the data stored in Bagger. It does this in the following way.
