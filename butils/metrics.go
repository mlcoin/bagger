...
func init() {
	NumReads = expvar.NewInt("bagger_disk_reads_total")
	NumWrites = expvar.NewInt("bagger_disk_writes_total")
	NumBytesRead = expvar.NewInt("bagger_read_bytes")
	NumBytesWritten = expvar.NewInt("bagger_written_bytes")
	NumLSMGets = expvar.NewMap("bagger_lsm_level_gets_total")
	NumLSMBloomHits = expvar.NewMap("bagger_lsm_bloom_hits_total")
	NumGets = expvar.NewInt("bagger_gets_total")
	NumPuts = expvar.NewInt("bagger_puts_total")
	NumBlockedPuts = expvar.NewInt("bagger_blocked_puts_total")
	NumMemtableGets = expvar.NewInt("bagger_memtable_gets_total")
	LSMSize = expvar.NewMap("bagger_lsm_size_bytes")
	VlogSize = expvar.NewMap("bagger_vlog_size_bytes")
	PendingWrites = expvar.NewMap("bagger_pending_writes_total")
}
