...
// Manifest represents the contents of the MANIFEST file in a Bagger store.
//
...
// openOrCreateManifestFile opens a Bagger manifest file if it exists, or creates on if
// one doesn’t.
